...
export default async function ProductPage({ params }: PageProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <section className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-10">
        {/* Product Image */}
        <div className="relative w-full aspect-[4/3] md:aspect-[3/2] bg-neutral-100 dark:bg-zinc-800 rounded-xl overflow-hidden">
          <Image
            src={product.image}
            alt={product.title}
            fill
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-base sm:text-lg mb-6 leading-relaxed max-w-prose">
            {product.description}
          </p>
